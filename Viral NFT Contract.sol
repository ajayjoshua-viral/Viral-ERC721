...
contract Viral is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("viral", "vrl") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://viralfoundation.org/images/Section-1-.png";
    }
